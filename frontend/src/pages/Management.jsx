  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 font-sans flex flex-col items-center justify-center p-4">
      <motion.div
        ...
        className="bg-gray-50 border border-gray-200 rounded-3xl p-12 text-center max-w-2xl shadow-sm"
      >
        <span className="text-[10px] font-black tracking-[0.4em] uppercase text-brand-orange mb-4 block italic">Institutional Leadership</span>
        <h1 className="text-4xl md:text-5xl font-black uppercase tracking-tighter mb-4 italic">
          Coming <span className="text-brand-blue font-light">Soon</span>
        </h1>
        <p className="text-gray-500 font-medium italic">
          We are currently updating our Management profiles. Please check back later.
        </p>
      </motion.div>
    </div>
  );
