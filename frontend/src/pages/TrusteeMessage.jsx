...
const TrusteeMessage = () => {
  return (
    <div className="min-h-screen bg-[#00162B] text-white font-sans flex flex-col items-center justify-center p-4">
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        className="bg-[#001f38]/90 backdrop-blur-2xl border border-white/10 rounded-3xl p-12 text-center max-w-2xl shadow-[0_32px_80px_rgba(0,0,0,0.7)]"
      >
        <span className="text-[10px] font-black tracking-[0.4em] uppercase text-brand-orange mb-4 block italic">Trustee's Message</span>
        <h1 className="text-4xl md:text-5xl font-black uppercase tracking-tighter mb-4 italic">
          Coming <span style={{ background: 'linear-gradient(90deg,#EA8214,#FFC850)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Soon</span>
        </h1>
