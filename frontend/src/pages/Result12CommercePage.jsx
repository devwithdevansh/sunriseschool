...
const RESULT_IMAGES = [
  // 2024-25
  { src: 'https://images.unsplash.com/photo-1523050854058-8df90110c9f1?q=80&w=1000&auto=format&fit=crop', label: 'Class 12 Commerce — Board Results', year: '2024-25' },
  { src: 'https://images.unsplash.com/photo-1509062522246-3755977927d7?q=80&w=1000&auto=format&fit=crop', label: 'Commerce Toppers — Group Photo', year: '2024-25' },
  ...
  // 2023-24
  { src: 'https://images.unsplash.com/photo-1577896851231-70ef18881754?q=80&w=1000&auto=format&fit=crop', label: 'Class 12 Commerce — Board Results', year: '2023-24' },
  { src: 'https://images.unsplash.com/photo-1580582932707-520aed937b7b?q=80&w=1000&auto=format&fit=crop', label: 'Commerce Toppers — Group Photo', year: '2023-24' },
  ...
  // 2022-23
  { src: 'https://images.unsplash.com/photo-1427504494785-3a9ca7044f45?q=80&w=1000&auto=format&fit=crop', label: 'Class 12 Commerce — Board Results', year: '2022-23' },
      ...
      <section className="pt-40 pb-20 px-4 md:px-8 max-w-[100rem] mx-auto">
        <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, ease: [0.16, 1, 0.3, 1] }}>
          ...
          <p className="text-xl md:text-2xl text-slate-500 font-light max-w-2xl leading-relaxed">
            A visual celebration of academic excellence. Explore the outstanding achievements of our Commerce students through the years.
          </p>
        </motion.div>
      </section>
