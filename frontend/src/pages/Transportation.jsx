    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans overflow-x-hidden selection:bg-brand-blue selection:text-white">
      ...
      <section className="relative pt-36 pb-32 md:pt-52 md:pb-44 overflow-hidden text-white">
        ...
        <div
          ...
          style={{ backgroundImage: `url('https://res.cloudinary.com/diymbygae/image/upload/v1782303543/sunrise-school/gallery/sunrise-school/gallery/WhatsApp_Image_2026-06-24_at_16.04.05.jpg')` }}
        />
        {/* Dark blue overlay for text readability */}
        <div className="absolute inset-0 bg-gradient-to-br from-blue-900/85 via-blue-800/80 to-blue-900/90" />
